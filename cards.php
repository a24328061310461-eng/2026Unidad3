...
<div class="container-fluid">
    ...
    <p style="text-align: center; color: var(--color-de-letras);"> Consulta de Registros
    Relacionados - Base de Datos Pro</p>
    ...
    <div class="cards-grid">
        <?php foreach ($personajes as $p): ?>
            <div class="x-card">
                ...
                <div class="card-body">
                    <p><span class="stat-label">Equipo:</span><?php echo htmlspecialchars($p
                    ['nombre_equipo'] ?? 'Independiente'); ?></p>

                    <p><span class="stat-label">Nombre Real:</span><?php echo
                    htmlspecialchars($p['nombre_real']); ?></p>

                    <p>
                        <span class="stat-label">Poderes:</span>
                        <?php echo htmlspecialchars($p['poderes']); ?>
                    </p>

                    <p>
                        <span class="stat-label">Altura:</span>
                        <?php echo htmlspecialchars($p['altura']); ?>
                    </p>

                    <hr>

                    <p class="small">
                        <em><?php echo nl2br(htmlspecialchars($p['bio'])); ?></em>
                    </p>
                </div>
